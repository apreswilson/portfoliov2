    ...
    return (
        <div className="flex h-[100dvh] justify-center items-center">
            ...
            <div className="flex flex-col text-center bg-black/30 z-10 rounded-lg p-6 gap-6 border border-white/20 shadow-xl">
                <h1 className="neon text-5xl text-white drop-shadow-black drop-shadow-xl">Alex Wilson</h1>
                ...
                <div className="flex flex-col gap-2">
                    {pages.map((page) => (
                        <NavLink
                            ...
                            to={page.url}
                            className={
                                "px-2 py-2 rounded-lg bg-black/40 border-white/20 border text-gray-200 hover:border-white/50 transition-all text-2xl hoveranim "
                            }
                        >
